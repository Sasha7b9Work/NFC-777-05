...
namespace ScriptLED
{
    ...
    static uint TIME_ENABLE = MS_IN_SEC * 60;               // Время начала отработки скрипта после последнего срабатывания
    static bool enabled = false;                            // Если true, скрипт будет выполняться, даже если не прошло time_enable времени
    ...
    namespace RunningWave
    {
        static const Step script1[] =
        {
            ...
            { 0x70FF0000, TypeStep::Color, 100 },
            { 0x70FFFF00, TypeStep::Color, 100 },   //                      жёлтый
            { 0x7000FF00, TypeStep::Color, 100 },   // Масимум              зелёный
            { 0x7000FFFF, TypeStep::Color, 100 },   //                      голубой
            { 0xFF0000FF, TypeStep::Color, 100 },   // Минимум - конец      синий
            { 0x7000FFFF, TypeStep::Color, 100 },
            { 0x7000FF00, TypeStep::Color, 100 },
            { 0x70FFFF00, TypeStep::Color, 100 },
            { 0x70FF0000, TypeStep::Color, 100 },
        ...
        {
            { 0x000000FF, TypeStep::Color, 0 },     // Минимум - начало
            { 0x70111111, TypeStep::Nop, 900 },
            { 0x70FF0000, TypeStep::Color, 100 },
            { 0x70FFFF00, TypeStep::Color, 100 },   //                      жёлтый
            { 0x7000FF00, TypeStep::Color, 100 },   // Масимум              зелёный
            { 0x7000FFFF, TypeStep::Color, 100 },   //                      голубой
    ...
    namespace BreathingSystem
    {
        static const Step script[] =
        {
            { 0x19FFFFFF, TypeStep::Color, 0  },    // 10%
            { 0x4cFFFFFF, TypeStep::Color, 500, },    // 30%
            { 0x80FFFFFF, TypeStep::Color, 500, },    // 50%
            { 0xb2FFFFFF, TypeStep::Color, 500, },    // 70%
            { 0xccFFFFFF, TypeStep::Color, 500, },    // 80%
            { 0x99FFFFFF, TypeStep::Color, 500, },    // 60%
            { 0x66FFFFFF, TypeStep::Color, 500, },    // 40%
            { 0x33FFFFFF, TypeStep::Color, 500, },    // 20%
            { 0x19FFFFFF, TypeStep::Color, 500, },    // 10%
            { 0xFFFFFFFF, TypeStep::Repeat }
        };
...
void ScriptLED::Update()
{
    ...
    if (meter_enable.ElapsedMS() < TIME_ENABLE && !enabled)
    {
        return;
    }
