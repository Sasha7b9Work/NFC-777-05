...
#define MFRC630_CMD_PWD_AUTH            0x1B
...
#define CODE_T_CL_SUCCESS       0x90    // Успешное завершение операции

#define CMD_SL0_WRITE_PERSO     0xA8
#define CMD_SL0_COMMIT_PERSO    0xAA
#define CMD_SL3_RESET_AUTH      0x78
#define CMD_SL3_FIRST_AUTH      0x70
#define CMD_SL3_FOLLOW_AUTH     0x76
#define CMD_SL3_READ_ENCRIPTED  ((uint8)0x31)
#define CMD_SL3_READ_PLAIN      ((uint8)0x33)
#define CMD_SL3_WRITE_ENCRIPTED ((uint8)0xA1)
#define CMD_SL3_WRITE_PLAIN     ((uint8)0xA3)
